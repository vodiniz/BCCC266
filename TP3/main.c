...
int main(int argc, char**argv) {
    ...
    if (argc != 7) {
        ...
        printf("Linha de execucao: ./exe TIPO_INSTRUCAO [TAMANHO_RAM|ARQUIVO_DE_INSTRUCOES] TAMANHO_L1 TAMANHO_L2 TAMANHO_L3 TAMANHO_HD\n");
        printf("\tExemplo 1 de execucao: ./exe random 10 2 4 6 8\n");
